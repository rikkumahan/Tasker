...
5. If you DO have all three areas covered and verified (or if the user has answered at least once for each category, even briefly), output "finished": true, generate the final "user_profile", "categories", "custom_extraction_rules", and a closing "ai_response".
