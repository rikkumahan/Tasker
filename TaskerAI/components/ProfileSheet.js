...
const IconSettings = ({ color = T.fg2 }) => (
  <View style={s.iconWrap}>
    <Svg width={18} height={18} viewBox="0 0 24 24" fill="none">
...
const IconDelete = ({ color = T.danger }) => (
  <View style={s.iconWrap}>
    <Svg width={18} height={18} viewBox="0 0 24 24" fill="none">
  ...
  return (
    ...
    >
      <Pressable style={s.overlay} onPress={onClose}>
        <Pressable style={s.sheet} pointerEvents="auto">
...
const s = StyleSheet.create({
  ...
  sheet: {
    ...
    paddingTop: T.sp6,
    paddingBottom: T.sp8 + 20, // offset navigation bars / safe area
    ...Platform.select({
